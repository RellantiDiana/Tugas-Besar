...
//       int a; //deklarasi variabel untuk perulangan
//       Input [] tebe ; //nama array
//       tebe = new Input [1]; } //jumlah array
       
       void InsertDataIdentitasRuangKelas(){  // inputan identitas ruang kelas
       int a;
       Input [] tebe;
       tebe = new Input[1];
       ...
       void InsertDataKondisiRuangKelas(){ // inputan kondisi ruang kelas
       int a;
       int panjang=0,luas=0,rasio=0,jumlahpintu=0,jumlahjendela=0;
       Input [] tebe;
       tebe = new Input[1];
       for(a=0;a<tebe.length;a++){
       tebe[a]=new Input();
       ...
       tebe[a].setJumlahjendela(in.nextInt());
         ...
         if (jumlahpintu>=2){ // analisis pintu dan jendela
            System.out.println("SESUAI");
        }
        else {
            System.out.println("TIDAK SESUAI");
        }   
          if (jumlahjendela>=1){ // kondisi ruang kelas
            System.out.println("SESUAI");
        }
        else {
            System.out.println("TIDAK SESUAI");
...
void InsertDataJumlahKondisiPosisiSarana(){ // inputan jumlah,kondisi,posisi sarana
    int jumlahstopkontak=0,kondisistopkontak=0,posisistopkontak=0;
    int jumlahkabellcd=0,kondisikabellcd=0,posisikabellcd=0;
    int jumlahlampu=0,kondisilampu=0,posisilampu=0;
    int jumlahkipasangin=0,kondisikipasangin=0,posisikipasangin=0;
    int jumlahAC=0,kondisiAC=0,posisiAC=0;
    int pilihSSID=0,bandwidth;
    int jumlahCCTV=0,kondisiCCTV=0,posisiCCTV=0;
    int a;
    Input [] tebe;
    tebe = new Input[1];
    for(a=0;a<tebe.length;a++){
   ...
   if (tebe[a].pilihSSID.equals("UMM Hotspot")){
    ...
    void InsertDataLingkunganRuangKelas(){ //inputan  linngkungan ruang kelas 
    int a;
    Input [] tebe;
    tebe = new Input[1];
    for(a=0;a<tebe.length;a++){
...
void InsertDataKebersihanRuangkelas(){ //inputan kebersihan ruang kelas
    int inputsirkulasiudara=0,pencahayaan=0,kelembapan=0,suhu=0;
    int a;
    Input [] tebe;
    tebe = new Input[1];
    for(a=0;a<tebe.length;a++){
...
void InsertDataKenyamananRuangKelas(){  //inputan kenyamanan ruang kelas
       int c,d,e,f,g;
       Scanner in = new Scanner (System.in);
      ...
      void InsertDataKeamananKelas(){   //inputan keamanan ruang kelas
       int h,i,j;
       Scanner in = new Scanner (System.in);
